...
extern const string inFolder = "randomSampleNoCuts/";

void histograms(std::string filename);
void histogramsByType(std::string filename);
void randomSampleNoCutsHistograms(){

  // 1. Load each Tree individually // joined                        
...
void histograms(std::string filename){
  ...
  std::string sufix1="_1.pdf";
  std::string sufix2="_2.pdf";
  std::string sufix3="_3.pdf";  
