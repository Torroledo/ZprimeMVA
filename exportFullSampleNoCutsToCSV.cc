...
void exportFullSampleNoCutsToCSV(){

  // 1. Load each Tree individually 
  std::string inFolder = "fullSampleNoCuts/";
  ...
  std::string back1 = "W+jets.root";
  std::string back2 = "DY+jets.root";
  ...
  writeFile(inFolder, inFolder, back1);
  writeFile(inFolder, inFolder, back2);
}
